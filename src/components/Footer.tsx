      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-9 h-9 rounded-lg bg-gold/20 border border-gold/40 flex items-center justify-center">
                <span className="text-gold font-bold text-base font-[Cairo]">ت</span>
              </div>
              <div className="flex flex-col">
                <span className="text-white font-semibold text-sm tracking-wide leading-tight">
                  TAJ MISR
                </span>
                <span className="text-gold/60 text-[9px] tracking-[0.2em] uppercase leading-tight">
                  Developments
                </span>
              </div>
            </div>
            <p className="text-sm leading-relaxed mb-6">
              ...
              prestigious destinations since 2009.
            </p>
            {/* Social Icons */}
            <div className="flex gap-3">
              {["facebook", "instagram", "linkedin", "youtube"].map((social) => (
                <a
                  ...
                  href="#"
                  aria-label={social}
                  className="w-9 h-9 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-gold/20 hover:border-gold/40 transition-all duration-300"
                >
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["De Joya", "De Joya 3", "Ezdan", "Pukka", "Azure"].map((p) => (
                <li key={p}>
                  <a
                    href="#projects"
                    className="text-sm hover:text-gold transition-colors duration-300"
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs">
            &copy; {new Date().getFullYear()} Taj Misr Developments. All rights reserved.
          </p>
